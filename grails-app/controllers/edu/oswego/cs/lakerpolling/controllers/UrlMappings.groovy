...
class UrlMappings {
    ...
    static mappings = {
        ...
        group "/api/quiz", {
            ...
            "/submission"(controller: 'quiz', action: 'submitQuiz', method: 'post')
            "/submission"(controller: 'quiz', action: 'getQuizSubmission', method: 'get')
            ...
            "/grades"(controller: 'quiz', action: 'getGrades', method: 'get')

            "/file/grades"(controller: 'quiz', action: 'downloadGrades', method: 'get')
        }
